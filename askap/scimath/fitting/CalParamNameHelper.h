...
/// @author Vitaliy Ogarko Moved from accessors to scimath.

#ifndef ASKAP_SCIMATH_CAL_PARAM_NAME_HELPER_H
#define ASKAP_SCIMATH_CAL_PARAM_NAME_HELPER_H
...
struct CalParamNameHelper {
  ...
  /// @brief extract parameter name without channel number
  /// @param[in] name name of the parameter
  /// @return base parameter name
  static std::string extractBaseParamName(const std::string &name);
};
...
#endif // #ifndef ASKAP_SCIMATH_CAL_PARAM_NAME_HELPER_H
